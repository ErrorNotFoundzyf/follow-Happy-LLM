...
def main():
    parser = argparse.ArgumentParser(description="SFT inference")
    parser.add_argument("--ckpt", type=str, required=True, help="路径: sft_*.pth")
    ...
    # 仅解码新增部分
    gen_text = tokenizer.decode(out_ids[0].tolist(), skip_special_tokens=True)
    print("\n=== Generated ===\n")
    print(gen_text)
